...
class NumericalPsystem():
    ...
    def simulate(self, stepByStepConfirm = False, printEachSystemState = True, maxSteps = -1, maxTime = -1):
        ...
        print("Sequential Python simulator\n")
        print("Simulation finished sucessfully \n")
        print("Number of Steps:%d\n"%(currentStep))
        print("Execution Time: %f seconds\n" %(currentTime-startTime))
        # print("Simulation finished succesfully after %d steps and %f seconds; End state below:" % (currentStep, currentTime - startTime))
        # print("Simulation finished successfully after %d %s%s%s and %f %s%s%s; End state below:\n" % (currentStep, bold, "steps", reset,currentTime - startTime, bold, "seconds", reset))
        self.print()
